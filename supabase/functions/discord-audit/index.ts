...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // service-role credential, fell into the user branch, failed getUser(), and
    // logged "Not authenticated". The cron check requires a NON-EMPTY service-role
    // bearer; an absent token is never the scheduler.
