...
export async function fetchLeagueData(seasonId) {
  ...
  const shapedDrivers = drivers
    ...
    .map((d) => {
      ...
      return { id: d.id, name: d.name, country: d.country || "", car: t.car || "", num: t.number, cls: t.class_id, teamId: t.id, custId: d.iracing_custid || "", irating: d.irating || null, licenseOverride: d.license_override || null };
    });
